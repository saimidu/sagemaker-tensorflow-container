...
def test_distributed_ps_3_1(instance_type, sagemaker_session, docker_image_uri):
    ...
    with timeout(minutes=30):
        estimator = MyEstimator(entry_point='mnist.py',
                                ...
                                hyperparameters={'num_parameter_servers': 3, 'num_workers': 1},
...
def test_distributed_ps_2_3(instance_type, sagemaker_session, docker_image_uri):
    script_path = 'test/resources/mnist/code'
    data_path = 'test/resources/mnist/data/training'
    with timeout(minutes=30):
        estimator = MyEstimator(entry_point='mnist.py',
                                ...
                                training_steps=1000,
                                evaluation_steps=100,
                                hyperparameters={'num_parameter_servers': 2, 'num_workers': 3},
                                train_instance_count=4,
                                train_instance_type=instance_type,
                                sagemaker_session=sagemaker_session,
                                docker_image_uri=docker_image_uri)
...
def test_distributed_ps_default(instance_type, sagemaker_session, docker_image_uri):
    script_path = 'test/resources/mnist/code'
    data_path = 'test/resources/mnist/data/training'
    with timeout(minutes=30):
        estimator = MyEstimator(entry_point='mnist.py',
